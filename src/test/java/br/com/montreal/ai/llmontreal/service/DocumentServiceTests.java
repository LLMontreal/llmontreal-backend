...
class DocumentServiceTests {
        ...
        @Mock
        private KafkaTemplate<String, KafkaSummaryResponseDTO> kafkaSummaryTemplate;
        ...
        void shouldReturnEmptyPageWhenNoDocumentsFoundByValidStatus() {
                when(documentRepository.findAllByStatus(eq(pageable), any(DocumentStatus.class)))
        ...
        void shouldUploadDocumentSuccessfully() throws Exception {
                ...
                KafkaSummaryResponseDTO summaryResponse = KafkaSummaryResponseDTO.builder()
                                .documentId(1L)
                                .summary("Resumo gerado")
                                .build();
                ...
                when(documentRepository.findById(1L))
                                .thenReturn(Optional.of(extractedDoc))
                                .thenReturn(Optional.of(completedDoc));

                when(documentExtractionService.extractContentSync(1L))
                                .thenReturn("Conteúdo extraído");

                when(ollamaProducerService.sendSummarizeRequest(any(Document.class), anyString()))
                                .thenReturn(CompletableFuture.completedFuture(summaryResponse));
                ...
                verify(documentExtractionService).extractContentSync(1L);
                verify(ollamaProducerService).sendSummarizeRequest(any(Document.class), eq("test-correlation-id"));
        }
        ...
        void shouldThrowExceptionForUnsupportedContentType(String contentType) {
                ...
                verify(documentRepository, never()).save(any(Document.class));
                verifyNoInteractions(documentExtractionService);
        }
